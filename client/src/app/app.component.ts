...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.canvas.freeDrawingBrush = new fabric[
      this.properties.brush.mode + "Brush"
    ](this.canvas);
  ...
  // Menu NavBar: Archivo
  rasterize() {
    this.resultImage = this.canvas.toDataURL({ format: "png" });
  }
  ...
  clone() {
    ...
    if (activeObject.toObject()) {
      ...
      if (clone) {
        clone.set({
          left: (activeObject.top ?? activeObject._objects[0].top) + 5,
          top: (activeObject.left ?? activeObject._objects[0].left) + 5,
        });
  ...
  setOpacity() {
    this.setActiveStyle(
      "opacity",
      parseInt(this.properties.opacity) / 100,
      null
    );
  }
  ...
  setLineHeight() {
    this.setActiveStyle(
      "lineHeight",
      parseFloat(this.properties.text.lineHeight),
      null
    );
  }
  ...
  setFontSize() {
    this.setActiveStyle(
      "fontSize",
      parseInt(this.properties.text.fontSize),
      null
    );
  }
  ...
  setBold() {
    ...
    this.setActiveStyle(
      "fontWeight",
      this.properties.text.fontWeight ? "bold" : "",
      null
    );
  }
  ...
  setFontStyle() {
    ...
    this.setActiveStyle(
      "fontStyle",
      this.properties.text.fontStyle ? "italic" : "",
      null
    );
  }
  ...
  getTextDecoration() {
    this.properties.text.decoration = this.getActiveStyle(
      "textDecoration",
      null
    );
  }
  ...
  setTextDecoration(value) {
    ...
    this.setActiveStyle(
      "textDecoration",
      this.properties.text.decoration,
      null
    );
  }
